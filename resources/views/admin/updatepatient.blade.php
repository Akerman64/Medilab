  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="col-12 grid-margin stretch-card" style="padding-inline: 25px; margin-top:25px;">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title" align='center' style="font-size:50px; color:darkorchid;">Entrez les données du malade</h4>

            <form class="forms-sample" method="POST" action="{{ url('uploadpatient', $patient->id) }}">
                @csrf
              ...
              <div class="form-group">
                <label for="exampleSelectGender">Genre</label>
                  <select class="form-control" value="{{ $patient->genre }}">
                    <option>Male</option>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="maladie" value="{{ $patient->maladie }}">
              </div>
              <div class="form-group">
                <label for="exampleInputCity1">Traitement</label>
                <input type="text" class="form-control" name="traitement" value="{{ $patient->traitement }}">
              </div>
              <div class="form-group">
                <label for="exampleTextarea1">Commentaire</label>
                <textarea class="form-control" name="commentaire" value="{{ $patient->commentaire }}" rows="4"></textarea>
              </div>
