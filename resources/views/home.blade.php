        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="content">
              ...
              <p>
                Medilab, à part etre une institution totalement privée, est fait pour toute personne voulant avoir un suivi parfait de sa santé. MediLab met à votre disposition les meilleurs soins et le meilleur personnel pour une optimalisation de votre santé.</p>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
            ...
            <p>Medilab met l'accent sur l'analyse rapide et la mise en place d'une stratégie permettant aux patients de guérir dans les meilleures conditions. Les aide-soignants sont tout aussi performants et professionels que les médecins titulaires.</p>
    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container">
        ...
        <form class="forms-sample" method="POST">
          ...
          <div class="form-group" style="padding-inline: 25px; margin-top:25px;">
            <textarea class="form-control" name="message" rows="4" placeholder="Commentaire"></textarea>
          </div>
